...
class TmdbServiceTest {
  ...
  void discoverMovieIds_withFiltersNoMaxDate_addsExpectedQueryParams() {
    ...
    MovieFilters filters = new MovieFilters(List.of(28L, 10749L), 7.5, minReleaseYear, null, "8|337");
    ...
    assertTrue(lastDiscoverUri.getQuery().contains("with_watch_providers=8|337"));
  }
  ...
  void discoverMovieIds_withFiltersWithMaxDate_addsExpectedQueryParams() {
    ...
    MovieFilters filters = new MovieFilters(List.of(28L, 10749L), 7.5, minReleaseYear, maxReleaseYear, "8|337");
  ...
  @Test
  void discoverMovieIds_withFiltersWithMaxDateNoProvider_addsExpectedQueryParams() {
    discoverResponse = """
        {
          "results": [
            { "id": 1 },
    ...
    MovieFilters filters = new MovieFilters(List.of(28L, 10749L), 7.5, minReleaseYear, maxReleaseYear, null);
    ...
    assertTrue(lastDiscoverUri.getQuery().contains("primary_release_date.gte=2024-01-01"));
    assertTrue(lastDiscoverUri.getQuery().contains("primary_release_date.lte=2026-12-31"));
    assertFalse(lastDiscoverUri.getQuery().contains("with_watch_providers="));
  }
